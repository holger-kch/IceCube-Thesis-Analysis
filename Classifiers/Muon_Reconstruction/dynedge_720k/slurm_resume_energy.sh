...
# Resume energy inference from checkpoint (epoch 35)
...
echo "=== DynEdge 720k — energy inference from checkpoint ==="
echo "Node:      $(hostname)"
echo "GPU:       $(nvidia-smi --query-gpu=name --format=csv,noheader 2>/dev/null || echo 'N/A')"
echo "Date:      $(date)"
echo "============================================="

python "${SCRIPT_DIR}/resume_energy_inference.py"
