...
#SBATCH --job-name=multitask_infer
#SBATCH --gres=gpu:1
...
# Inference-only for Multi-Task Transformer (all 3 targets at once)
# Usage: sbatch slurm_inference.sh
...
echo "=== Multi-Task Transformer Inference ==="
