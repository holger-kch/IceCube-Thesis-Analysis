...
| MC `kappa < 10` split table | Shows median event properties for low- and high-`kappa` MC events | Generated by [make_mc_kappa_split_table.py](../analysis/MC_vs_BS_analysis/GBreweighting/validation/make_mc_kappa_split_table.py) |
