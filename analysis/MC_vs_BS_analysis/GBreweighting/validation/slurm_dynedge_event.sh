...
# Usage: sbatch slurm_dynedge_event.sh [args forwarded to python script]
...
echo "=== DynEdge event-level MC-vs-data ==="
echo "Node: $(hostname)"
...
"${PYTHON}" train_dynedge_event_separate.py "$@"
