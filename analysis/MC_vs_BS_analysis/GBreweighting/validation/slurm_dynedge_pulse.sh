...
# Usage: sbatch slurm_dynedge_pulse.sh [args forwarded to python script]
...
echo "=== DynEdge pulse-level MC-vs-data ==="
echo "Node: $(hostname)"
...
"${PYTHON}" train_dynedge_pulse_separate.py "$@"
