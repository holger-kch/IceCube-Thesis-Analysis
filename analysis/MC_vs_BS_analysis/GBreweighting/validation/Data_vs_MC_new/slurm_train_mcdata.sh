...
#SBATCH --job-name=data_vs_mc_new
#SBATCH --array=0-1%2
#SBATCH --gres=gpu:1
...
OUT_DIR="${SCRIPT_DIR}/results/transformer_data_vs_mc_${CLASS_NAME}_hlc_rde_unmergedsplit"
...
echo "=== Data-vs-MC transformer: ${CLASS_NAME}, unmergedsplit, HLC/RDE, no width/pmt_area ==="
echo "Node: $(hostname)"
