...
#SBATCH --job-name=data_vs_mc_k10_fw
#SBATCH --array=0-1%2
#SBATCH --gres=gpu:1
...
OUT_DIR="${SCRIPT_DIR}/results/transformer_data_vs_mc_${CLASS_NAME}_hlc_rde_merged_v2_kappa10_finalweight_transformer_hlcflip_best"
...
echo "=== Data-vs-MC transformer: ${CLASS_NAME}, merged v2 + Transformer HLC best flip, kappa >= 10, final_weight ==="
echo "Node: $(hostname)"
