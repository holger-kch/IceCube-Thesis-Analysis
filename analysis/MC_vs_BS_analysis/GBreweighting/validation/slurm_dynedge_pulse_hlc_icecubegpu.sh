...
# Usage: sbatch slurm_dynedge_pulse_hlc_icecubegpu.sh [args forwarded to python script]
...
echo "=== DynEdge per-pulse HLC classifier ==="
echo "Node: $(hostname)"
...
"${PYTHON}" train_dynedge_pulse_hlc.py "$@"
